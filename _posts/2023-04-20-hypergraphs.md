...
Figure 2: Scale-free (or power law) fit for incoming degrees in the three regimes with estimated alpha in inset.
...
Figure 3: Average shortest path lengths for various regimes as function of the number of nodes in the sub-sampled graph.
